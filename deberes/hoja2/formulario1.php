<form action="<?= $_SERVER["PHP_SELF"] ?>" method="post" name="form1" id="form1">
	<p>
		...
		<input type="text" name="num1" id="num1" placeholder="Introduce un número" required autofocus patter="\d{1}"  <?php mostrar_campo("num1"); ?> >
	...
	<p>
		<label for="num3">Introduce el primer número:</label>
