		...
		<div class="contenedor">
			<div class="ejercicio">
				...
				<?php
					...
					//en esta verión lo hacemos asociativo
					//En está versión la generaremos arriba
					$errores = [];
					include_once 'funciones6.php';
					...
					//sino te comprueba los campos del formulario
						...
						if (!isset($_POST['nombre']) || empty($_POST['nombre'])) {
							...
							$errores["nombre"] =  "No se ha recivido el nombre";
						...
						if (!isset($_POST['email']) || empty($_POST['email'])){
							...
							$errores["email"] = "No se ha recivido un E-mail";
						...
						if (!isset($_POST['clave1']) || !isset($_POST['clave2'])) {
							...
							$errores["clave1"] = "No se ha recivido las 2 contraseñas";
							
						} else {

							if (strlen($_POST['clave1']) < 5) {
								
								$errores["clave1"] = "La contraseña no tiene la longitud necesaria";
								
							}

							if ($_POST['clave1'] != $_POST['clave2']) {
								
								$errores["clave1"] = "Las contraseñas son distintas";
